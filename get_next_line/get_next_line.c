...
/*   Updated: 2025/12/26 18:09:53 by ahmad_nashw      ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static void	*polish_list(t_str **list, t_str *node, size_t index, int eof)
{
	char	*last_string;
	size_t	i;
	t_str	*last_node;
...
static char	*get_line_from_node(t_str **list, int eof)
{
	char	*line;
	size_t	j;
	size_t	index;
...
static int	process_line(char *buffer, t_str **list)
{
	ssize_t	i;
	t_str	*new_node;
...
static char	*search_for_line(int fd, t_str **list)
{
	char	*buffer;
	ssize_t	bytes;
	int		check;
